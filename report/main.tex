...
We then scored every model and chose the one with the best score. The following plots show the \textit{RMSE} and \textit{R2} scores (y axis) for every model (x axis).
\begin{figure}[ht]
\centering
